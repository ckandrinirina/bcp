...
class ServiceManager implements ServiceManagerInterface
{
    ...
    public function __construct(ContainerInterface $oContainer) {
        ...
        $this->oEtablissementRepository = $this->oEm->getRepository('BcpBundle:Etablissement');
    }
    ...
    public function createEtablissement($oContainer, $aRequestContent, $oFile, $bSave = true) {
        ...
        $oEtablissement->setNom($aRequestContent['bcpbundle_etablissement']['nom']);
        $oEtablissement->setAdresse($aRequestContent['bcpbundle_etablissement']['adresse']);
        $oEtablissement->setAutre($aRequestContent['bcpbundle_etablissement']['autre']);
        $oEtablissement->setEmail($aRequestContent['bcpbundle_etablissement']['email']);
        $oEtablissement->setFixe($aRequestContent['bcpbundle_etablissement']['fixe']);
        $oEtablissement->setNom($aRequestContent['bcpbundle_etablissement']['nom']);
        $oEtablissement->setNote($aRequestContent['bcpbundle_etablissement']['note']);
        $oEtablissement->setPrix($aRequestContent['bcpbundle_etablissement']['prix']);
        $oEtablissement->setSite($aRequestContent['bcpbundle_etablissement']['site']);
        $oEtablissement->setSpecialite($aRequestContent['bcpbundle_etablissement']['specialite']);
        $oEtablissement->setType($aRequestContent['bcpbundle_etablissement']['type']);
        if ($bSave) {
