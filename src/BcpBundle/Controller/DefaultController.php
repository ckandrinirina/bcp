...
use BcpBundle\Manager\ServiceManagerInterface;
...
class DefaultController extends CommonController
{
    ...
    public function homeAction(Request $oRequest) {
        return $this->render('@Bcp/Etablissement/home.html.twig');
    }
    ...
    public function etablissementAction(Request $oRequest) {
        ...
        return $this->render('@Bcp/Etablissement/etablissement.html.twig', array(
            'items' => $aItems,
    ...
    public function recetteAction() {
        return $this->render('@Bcp/Etablissement/recette.html.twig');
    }
    ...
    public function contactAction(Request $oRequest) {
        ...
        return $this->render('@Bcp/Etablissement/contact.html.twig');
    }
    ...
    public function ficheAction(Etablissement $oEtablissement) {
        ...
        return $this->render('@Bcp/Etablissement/fiche.html.twig', ['etablissement' => $aoEtablissement[0]]);
    }
