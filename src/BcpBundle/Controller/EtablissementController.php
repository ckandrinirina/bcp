...
use BcpBundle\Manager\ServiceManager;
...
class EtablissementController extends CommonController
{
    ...
    public function indexAction(Request $request) {
        ...
        return $this->render('@Bcp/admin/etablissement/index.html.twig', array(
    ...
    public function newAction(Request $request) {
        if ($request->getMethod() == 'POST'){
            $file = $request->files->get('bcpbundle_etablissement')['file'];
            $aRequestContent = $request->request->all();
            if ($file instanceof UploadedFile && !empty($aRequestContent) && key_exists('bcpbundle_etablissement', $aRequestContent)){
        ...
        return $this->render('@Bcp/admin/etablissement/new.html.twig', array());
    }
    ...
    public function showAction(Etablissement $oEtablissement) {
        ...
        return $this->render('@Bcp/admin/etablissement/show.html.twig', array(
    ...
    public function editAction(Request $request, Etablissement $oEtablissement) {
        $deleteForm = $this->createDeleteForm($oEtablissement);
        $editForm = $this->createForm('BcpBundle\Form\EtablissementType', $oEtablissement);
        $editForm->handleRequest($request);
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->oManager->crudObject($oEtablissement, 'update');
            return $this->redirectToRoute('etablissement_index');
        }
        return $this->render('@Bcp/admin/etablissement/edit.html.twig', array(
            'etablissement' => $oEtablissement,
